    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CompanyPhoneNumber', models.CharField(blank=True, max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('MemberFullName', models.CharField(blank=True, max_length=100)),
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='members', to='dashboard.company')),
            ],
        ),
        migrations.CreateModel(
            name='ProjectImage',
